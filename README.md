...
flowchart TB
    subgraph ClientLayer ["Client & Experience Layer (Next.js 16 + React 19)"]
        ...
        ThreeGlobe["Interactive 3D Three.js Globe Visualizer"]
        Switcher["SIH 1-Click Persona Switcher Modal"]
        RechartsComp["Analytics & Skill Heatmap (Recharts)"]
    end
...
sequenceDiagram
    ...
    alt PRI Score >= 850
        ...
        Industry->>Student: Direct Job Pitch (Role + Stipend + Offer)
        Student->>Industry: Accept Offer
        Industry->>TPO: Placement Funnel Updated in Real-Time
    end
```
